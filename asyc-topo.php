        ...
        <nav class="navbar navbar-dark bg-dark navbar-expand-sm ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto me-5 pe-5">
              ...
              <li class="nav-item me-2">
                <a href="asyc-pageCliente.php" class="nav-link ">Clientes</a>
              </li>
              <li class="nav-item me-2">
                <a href="asyc-pageEstoque.php" class="nav-link ">Estoque</a>
              </li>
              <li class="nav-item me-2">
                <a href="asyc-pageRh.php" class="nav-link ">RH</a>
              </li>
              <li class="nav-item me-2 ">
                <a href="financeiroLancamento.php" class="nav-link ">Finaceiro</a>
              </li>
              <li class="nav-item">
